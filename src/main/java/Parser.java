...
public class Parser {
    ...
    public void processTask(String input, TaskType type) throws MissingArgumentException, 
           IOException {
    ...
    public void showList() throws EmptyListException {
        int taskCount = tasks.getTaskCount(); 
        if (taskCount == 0) {
    ...
    public void markTask(String taskNum) throws OutOfListBoundsException, IOException {
    ...
    public void unmarkTask(String taskNum) throws OutOfListBoundsException, IOException {
        int taskNumber = Integer.parseInt(taskNum) - 1;
        if (taskNumber >= listCount || taskNumber < 0) {
            throw new OutOfListBoundsException();
        }
    ...
    public void deleteTask(String taskNum) throws OutOfListBoundsException, IOException {
        int taskNumber = Integer.parseInt(taskNum) - 1;
        if (taskNumber >= listCount || taskNumber < 0) {
            throw new OutOfListBoundsException();
        }
    ...
    public boolean executeCommand(String input, String[] instruction) 
    ...
    public boolean processInput(String input, TaskList tasks) {
        String[] instruction = input.split(" ");
        try {
            this.tasks = tasks;
            return executeCommand(input, instruction);
