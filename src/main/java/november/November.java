...
/**
 * Represents the November chatbot, which is a command-line tool for task management.
 */
public class November {
    ...
    private static final String MARK_TASK_MESSAGE = "Nice! I've marked this task as done: "; // Message when a task is marked as done
    private static final String UNMARK_TASK_MESSAGE = "Ok, I've marked this task as not done yet: "; // Message when a task is unmarked
    ...
    /**
     * The main method for running the November chatbot.
     *
