...
public class Parser {
    ...
    static {
        COMMAND_PARSERS.put(CommandType.TODO, Parser::parseTodo);
        COMMAND_PARSERS.put(CommandType.DEADLINE, Parser::parseDeadline);
        COMMAND_PARSERS.put(CommandType.EVENT, Parser::parseEvent);
    }
     ...
     */
    public static void processCommand(String command, TaskList taskList) throws IllegalArgumentException {
